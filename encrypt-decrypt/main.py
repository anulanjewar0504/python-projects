...
def main_screen():
    ...
    Label(text="Enter text for encryption and decryption:",fg="black",font=("calnri",13)).place(x=10,y=10)
    text1=Text(font="Robot 20",bg="white",relief=GROOVE,wrap=WORD,bd=0)
    text1.place(x=10,y=50,width=355,height=100)

    Label(text="Enter password",fg="black",font=("calibri",13)).place(x=10,y=170)
    ...
    Button(text="REST",height="2",width=50,bg="#1089ff",fg="white",bd=1,command=rest).place(x=10,y=300)
    screen.mainloop()
